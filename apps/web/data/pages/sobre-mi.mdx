...
¡Hola! Mi nombre es **Carlos Azaustre**. Nací hace 38 años en Madrid (España).
...
Estoy reconocido por Google desde 2019 (¡5 años ya!) como _Developer Expert_
[GDE en Tecnologías web](https://g.dev/carlosazaustre) y premiado en 2022 y 2023 como
[Microsoft MVP (Most Valuable Professional)](https://mvp.microsoft.com/es-es/PublicProfile/5004840?fullName=Carlos%20Azaustre).

Durante los últimos años he publicado varios libros, cursos online e impartido charlas y talleres.
También publico contenido en [este blog](https://carlosazaustre.es/blog) y en [mi canal de Youtube, al que te animo que se suscribas (¡ya somos más de 130,000!)](https://youtube.com/carlosazaustre?sub_confirmation=1)
...
- **2022**
  ...
  - ✈️ Viajo a Barcelona por el Mobile World Congress.
  - 🐶 Kara nos dejó...
  - ⭐️ Llegamos a 100,000 seguidores en [Instagram](https://instagram.com/carlosazaustre).
  - 💻 Trabajo durante unos meses en una Startup.
  ...
  - 👥 Se celebra el Google Community Summit Spain en Madrid, dónde nos reunimos GDGs, GDEs, WTMs, GSDCs,...
  - 🎙️ Viajamos a Burgos, con motivo de la MorcillaConf (DevFest Burgos).
  - ⭐️ Conseguimos el *Partner* de Discord con el servidor/comunidad "PintaAPIs Developers"
  - 👨‍🏫 Imparto un taller de React para estudiantes en la Universidad Europea de Madrid.

---
- **2023**
 - 🎓 Comienzo a trabajar como Profesor Asociado en la Universidad Europea de Madrid.
 - ✈️ Viajamos a Menorca para dar una Charla en las STEM Talks 2023 Menorca.
 - 🎙️ Doy charla en T3chFest 2023 en Madrid.
 - 🎙️ Doy charla en los SciTech Days de la Universidad Europea de Madrid.
 - 🎮 Me compro la Switch y me vicio al Zelda Breath of the Wild y Tears of the Kingdom.
 - 💻 Empiezo a colaborar con Garaje de Ideas como creador de contenido académico.
 - 🧑‍✈️ Soy embajador del Manifiesto [Por la Informática en España](https://www.manifiestoporlainformatica.com/)
 - 🎙️ Participo en OpenExpo Europe 2023
 - 🪛 Monto un PC por primera vez en ¿20 años?
 - 📘 Publico el libro *[Aprendiendo React](https://amzn.to/3PBuEhZ)* con Amazon.
 - ✈️ Viajo a San Francisco 🇺🇸 por el GDE DevFest Bootcamp.
...
![Carlos Azaustre con la placa de 100000 de Youtube y los premios de Microsoft y Google Expert](/images/sobre-mi/carlosazaustre_youtube.jpg)

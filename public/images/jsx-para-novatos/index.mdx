...
![resultado react jsx](./ejemplo-jsx.png)
...
Para poder utilizar JSX, necesitarías añadir una librería extra a tu HTML, pero es más aconsejable utilizar un *bundler* integrado en tu entorno de desarrollo, como puede ser WebPack o [Browserify](/browserify-desarrollando-tu-frontend-como-en-node-js/), y que éste le aplique la transformación antes de publicar tu código en producción. De esto hablaré en próximas entradas.

...
slug: "/angular-2-primeros-pasos"
date: 2015-11-09
tags:
  - "💻 Desarrollo"
---
El pasado viernes [fuí invitado como ponente al #DevFestCordoba](//cordoba.gdgdevfest.com/speakers/) organizado por el [GDG de Córdoba](//twitter.com/gdgcordobaESP) (España). Mi charla fue sobre Angular 2. Qué trae nuevo y qué deja atrás.

![Angular 2 basado en ECMAScript6 y WebComponents](./angular-2-ecmascript6-webcomponents.png)
...
![Trabajando con Angular 2 y las herramientas Browserify y Babel](./angular-2-browserify-y-babel.png)
...
* **zone.js** Implementa *Zones* en JavaScript. Una
*Zone* es un contexto de ejecución que persiste a través de tareas asíncronas. Si no lo incluimos, las rutas por ejemplo no Funcionarán.
...
![Localhost con aplicación en Angular 2](./tutorial-angular-2.png)

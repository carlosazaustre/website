...
slug: "/que-son-las-firebase-cloud-functions"
date: 2017-06-19
tags:
  - "💻 Desarrollo"
---
...
![Cloud Functions for Firebase](./firebase_cloud_functions_for_startups.jpg)
...
![Notificaciones con Firebase Cloud Functions](./notify.png)
...
![Sanitizacion de mensajes](./sanitization.png)
...
![Thumbnail de imágenes](./intensive.png)
...
*Más información y fuentes: [Cloud Functions for Firebase Documentation](https://firebase.google.com/docs/functions/).*
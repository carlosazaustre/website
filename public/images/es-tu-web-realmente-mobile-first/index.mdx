...
slug: "/es-tu-web-realmente-mobile-first"
date: 2015-10-14
tags:
  - "💻 Desarrollo"
---
...
No es así en todos los mercados, los desarrolladores solemos *googlear* o buscar en *Stackoverflow* cuando estamos programando en nuestros laptop o desktops. 
...
![Graceful Degradation vs Progressive Enhancement](./graceful-degradations-vs-progressive-enhancement.png)
...
Es la técnica que se utilizaba hasta ahora para darle a una web un diseño *Responsive*.
...
*Mobile First* nos exige a los desarrolladores y diseñadores a crear productos con el mínimo de funcionalidades, para centrarnos más en el contenido que se ofrece y en la experiencia de usuario.
...
![Mobile Friendly Test](./mobile-friendly-test.png)

En el caso de que tengamos algún error, esta herramienta nos avisa y nos da indicaciones para corregirlo.

Si nuestra página es *Mobile-Friendly*, cuando hagamos una búsqueda en Google desde un smartphone veremos el tag:

![Página de resultados de Google en Mobile](./resultado-de-google-en-mobile.png)
...
![Google PageSpeed Insights](./resultado-pagespeed-insights.png)

...
slug: "/que-es-lo-que-me-gusta-de-vue-js"
date: 2017-08-16
tags:
    - "💻 Desarrollo"
---
...
Todos los veranos me gusta aprovechar para aprender algo nuevo. [El año pasado le dí una oportunidad a React](https://carlosazaustre.es/mi-inmersion-en-react/) y me gustó mucho, tanto que opté por dejar Angular (v1.x) a un lado y trabajar con React.js. Este verano le ha tocado a Vue, y en éste post te quiero contar por qué me ha *conVUEncido* 😉.

<YouTube videoId="3D5aos_rbrw" />

## Framework Progresivo

[Vue.js](//vuejs.org) es un framework progresivo, eso quiere decir que podemos usarlo para algo múy básico, igual que antes se usaba jQuery para cosas sencillas, o para algo más complejo como el desarrollo de una SPA, o para *Server-Rendering.* Siempre con un rendimiento y experiencia de desarrollo muy buena. 

![995016_ebf4](./995016_ebf4.jpg)
...
![Vue método del lifecycle](./lifecycle.png)
...
Para finalizar, comparto este *Tweet* de [Rafael Casuso](https://twitter.com/Rafael_Casuso), organizador de [VueJS Madrid](https://www.meetup.com/VueJS-Madrid/) que también ha trabajado con muchos proyectos y en todos ha utilizado frameworks y librerías diferentes:

<blockquote class="twitter-tweet" data-lang="en"><p lang="es" dir="ltr">No te ancles ideológicamente a ningún framework o lenguaje. Aprende, evoluciona, prueba, compara. No existe la bala de plata.</p>&mdash; Rafael Casuso (@Rafael_Casuso) <a href="https://twitter.com/Rafael_Casuso/status/886951748170125312">July 17, 2017</a></blockquote>

...
Yo por mi parte me apunté a la lista de correo y ya he pre-pedido mi Tessel, la versión básica con un módulo de clase A, posiblemente pida el acelerómetro o el sensor de temperatura. El *Master pack* también está muy interesante ya que incluye todos los sensores, pero me parecía un precio demasiado elevado.

![tier_tessel_a](./tier_tessel_a_gcqfj1.png)

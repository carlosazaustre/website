...
slug: "/uso-de-promesas-en-angularjs"
date: 2015-04-27
tags:
    - "💻 Desarrollo"
---
...
Hay que indicar que una **Promesa** no nos sustituye el hecho de utilizar callbacks para leer su valor, pero lo que nos evita es caer en el temido *Callback Hell*.
...
Utilizaremos en su lugar los métodos `then()` y `catch()` para implementar la funcionalidad. El ejemplo del *Callback Hell* anterior con promesas sería de la siguiente manera:

...
slug: "/formas-de-comunicar-componentes-en-angularjs-1-x/"
date: 2016-01-27
tags:
  - "💻 Desarrollo"
---
...
![Aplicación Base](./comm_ang_ejemploBase.png)
...
![Herencia $scope](./comm_ang_herenciaScope.png)
...
AngularJS 1.x proporciona un [sistema de eventos](https://docs.angularjs.org/api/ng/type/$rootScope.Scope#$on) muy útil al que se accede mediante los **métodos *$broadcast*, *$on* y *$emit***.
...
![Comunicando con eventos](./comm_ang_forma2.png)
...
![Comunicando con servicios](./comm_ang_forma3.png)

...
slug: "/como-crear-un-servidor-web-con-amazon-web-services"
date: 2013-07-23
tags:
    - "💻 Desarrollo"
---
A veces necesitamos de un servidor web para *testing* y no nos sirve con nuestro entorno de desarrollo local porque necesitamos enseñarle a alguien lo que estamos haciendo y por tanto es necesario que esté subido en algún sitio.
...
![](./amazon_com_web_services_qepgql.jpg)
...
![Registrase en AWS](./Screen-Shot-2013-07-25-at-16_48_30_l14vfb.png)

![Registrase en AWS](./Screen-Shot-2013-07-25-at-16_48_42_b82pcm.png)

![Registrase en AWS](./Screen-Shot-2013-07-25-at-16_48_52_lhkoua-1.png)
...
![Tasksel para instalar LAMP en Linux](./Screen-Shot-2013-07-25-at-17_19_22_jhte9m.png)
...
![Apache Web Server](./Screen-Shot-2013-07-25-at-17_22_30_yfatt2.png)

...
<iframe
  src="//www.slideshare.net/slideshow/embed_code/key/k5V7VKzc3BuQxW"
  width="425"
  height="355"
  frameborder="0"
  marginwidth="0"
...
>
  ...
  <strong>
    {" "}
    <a
      href="//www.slideshare.net/CarlosAzaustre/game-of-frameworks-gdg-cceres-codecc"
      title="Game of Frameworks - GDG Cáceres #CodeCC"
      target="_blank"
    >

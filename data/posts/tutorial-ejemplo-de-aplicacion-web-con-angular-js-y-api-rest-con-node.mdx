...
Vamos a ver como crear una [_Single Page Application_](//en.wikipedia.org/wiki/Single-page_application), y como conectarla a una [API REST construida con NodeJS](/como-crear-una-api-rest-usando-node-js/) y Mongo como base de datos. Completando así el Stack tecnológico conocido como, [MEAN](http://mean.io).

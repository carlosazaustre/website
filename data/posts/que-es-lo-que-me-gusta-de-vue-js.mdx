...
[Vue.js](//vuejs.org) es un framework progresivo, eso quiere decir que podemos usarlo para algo múy básico, igual que antes se usaba jQuery para cosas sencillas, o para algo más complejo como el desarrollo de una SPA, o para _Server-Rendering._ Siempre con un rendimiento y experiencia de desarrollo muy buena.
...
Éste gráfico está sacado de la [documentación oficial](//vuejs.org/v2/guide/instance.html#Instance-Lifecycle-Hooks) (también muy clara y fácil de seguir) dónde se puede ver todos los momentos en los que podemos acceder para añadir o eliminar funcionalidades.
...
Parece un paso atrás, pero personalmente, tal y cómo funciona Vue, me parece una forma muy correcta de uso. [Aquí](//github.com/vuejs/vue/issues/2371#issuecomment-186238466) y Evan You, al autor de Vue, explica sus razones]
